...
- **Avantages** : Pas d’installation requise , outil multiplateforme ,commente le travaille et Collaboration facile.
- **Inconvénients** :connexion Internet active requise.
- **Disponibilité** : macOS, Windows et mobile.
- **Prix** : Version de démarrage gratuite ou 12 $/mois pour plus des avantages .
...
- **Catégorie** : Software Interface Utilisateur , interface experience .
- **Avantages** : Interface interactive. Facile pour créer des interfaces d'applications et des sites web.
...
- **Catégorie** : Software Interface Utilisateur , interface experience .
- **Avantages** :  Avec son application Mirror, Sketch intègre la possibilité de designer en temps réel au sein d’un mobile, très pratique pour les tests multi-écrans.
- **Inconvénients** : Disponible seulement par MacOS 
- **Disponibilité** : MacOS
